  ...
  return (
    ...
    >
      ...
      <a
        ...
        onClick={dismissTip}
        className="group relative grid place-items-center h-14 w-14 rounded-full bg-card dark:bg-card border-[3px] shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 hover:bg-[#308450] dark:hover:bg-[#308450]"
