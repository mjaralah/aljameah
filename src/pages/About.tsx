...
const strategicGoals = [
  ...
  { t: "الحوكمة والشفافية", d: "تطبيق أعلى معايير الحوكمة وفق رؤية المملكة 2030." },
];
  ...
  return (
    <>
      <PageHero
        eyebrow="تعرّف علينا"
        title={t.about.title}
        lead="جمعيةٌ خيرية مرخّصة، تنطلق من قيم العطاء والأمانة لتُسهم في بناء مجتمعٍ متكافل، وتعمل وفق أعلى معايير الحوكمة والشفافية."
          ...
          <div className="space-y-10 md:space-y-14 min-w-0">
            ...
            <SectionBlock id="founding" icon={Sparkles} title="النشأة والتأسيس">
              <p>
                ...
                الوزارة المختصة، تحت السجل رقم <strong>1234/2020</strong>، استجابةً لحاجة
