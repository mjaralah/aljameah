        ...
        <Card>
          <CardContent className="p-5 md:p-6">
            <SectionHeader
              ...
              description="إيقاف نشر صفحة كاملة سيُظهر للزوار رسالة 'غير متاحة حالياً'. ملاحظة: التحكم بأعمدة التذييل (تعريف الجمعية، روابط سريعة، الخدمات الإلكترونية، المعلومات القانونية، تواصل معنا) يتم من صفحة «تذييل الموقع»، وهنا فقط شريط الحقوق السفلي وخريطة الموقع."
            />
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {PUBLIC_PAGES.map((p) => (
                <div key={p.key} className="flex items-center justify-between rounded-lg border p-3 bg-muted/30">
