        ...
        <section className="grid md:grid-cols-2 gap-5">
          <Card className="p-6 space-y-4">
            <div>
              ...
              <h3 className="text-lg font-bold">لم تجد إجابة؟ راسل الدعم التقني</h3>
              <p className="text-xs text-muted-foreground mt-1">
                سيتم الرد عليك على بريدك خلال يوم عمل
              </p>
            </div>
            <form onSubmit={onContactSubmit} className="space-y-3">
              ...
              <Input
                ...
                required
              />
              <Input name="phone" type="tel" placeholder="رقم الجوال (اختياري)" />
              <Textarea
                name="message"
                placeholder="صف المشكلة أو السؤال بالتفصيل..."
                rows={5}
                required
              />
          ...
          <Card className="p-6 space-y-4">
            <div>
              ...
              <h3 className="text-lg font-bold">أدلة وفيديوهات تدريبية</h3>
              <p className="text-xs text-muted-foreground mt-1">
                موارد سريعة تساعدك على إتقان إدارة الموقع
              </p>
            </div>
            {quickLinks.length === 0 ? (
              <p className="text-sm text-muted-foreground py-6 text-center">
                لم تتم إضافة روابط بعد. يمكنك إضافتها من «صفحة الدعم العامة» في الإعدادات.
              </p>
            ) : (
